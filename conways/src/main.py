...
class Game:
    ...
    def __init__(self, title: str = "NSCCSC Life Clone") -> None:
        ...
        infinit = [(207, 200), (205, 201), (207, 201), (208, 201), (205, 202), (207, 202), (205, 203), (203, 204), (201, 205), (203, 205)]
        ...
        for cell in time_bomb:
            (x,y) = cell
            Cell.instances[(x + GRID_LEN/2, y + GRID_LEN/2)].set_alive()
